...
public:
    ...
    /**
     * Adding vectors into a built index, only HNSW supported now, called on other index will cause
     * exception
     *
     * @param base should contains dim, num_elements, ids and vectors
     * @return IDs that failed to insert into the index
    ...
    /**
     * Pretraining the conjugate graph involves searching with generated queries and providing
     * feedback.
     *
