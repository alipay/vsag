...
public:
    using IdCountsType = InnerIdType;
...
public:
    virtual void
    SetMaxCapacity(IdCountsType capacity) {
    ...
    [[nodiscard]] virtual IdCountsType
    TotalCount() const {
...
public:
    IdCountsType total_count_{0};
    IdCountsType max_capacity_{1000000};
